<template>
  <page-layout title="Create Group">
    <div class="create-group-wrapper">
      <h1 v-if="!groupCreated" class="heading-create-group">
        Erstellen Sie eine <span>Gruppe</span>
      </h1>
      <div
        v-if="!groupCreated"
        class="create-event"
...
export default {
  ...
  methods: {
    ...
    async onClickSubmit() {
      ...
      await axios
        .post(
          "https://student.cloud.htl-leonding.ac.at/connecting-memories/api/eventgroup/addEventGroup",
          {
        ...
        .then((response) => {
          ...
          this.invitationLink =
            "http://localhost:8081/#/submitToGroup?id=" + response.data.id;
